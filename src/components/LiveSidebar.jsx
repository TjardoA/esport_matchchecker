    ...
    <aside className="relative overflow-hidden bg-stone-950 border border-stone-800 rounded-2xl p-5 sm:p-6 shadow-lg shadow-black/28 space-y-4 self-start w-full min-h-[240px] sm:min-h-[320px]">
      <div className="relative flex items-center justify-between">
        <div className="space-y-1">
          <p className="text-xs uppercase tracking-[0.22em] text-purple-200/80">Now playing</p>
          <h2 className="text-xl font-semibold text-white">Live matches</h2>
        </div>
        <span className="px-2.5 py-1 text-xs font-semibold rounded-full bg-purple-500/15 text-purple-100 border border-purple-300/40 shadow-inner shadow-black/20">
          {liveMatches.length}
        </span>
      </div>
        ...
        <div className="relative space-y-3">
          {liveMatches.map((match) => (
            <div
              ...
              style={{
                borderLeftColor: match.accent || "#a855f7",
                borderLeftWidth: "5px",
            ...
            >
              <div className="flex items-center justify-between text-xs text-stone-400 mb-2 gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full bg-purple-600/20 text-purple-100 border border-purple-400/30 font-semibold">
                  Live
                </span>
              </div>
